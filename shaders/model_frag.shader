...
void main()
{
    ambientSample = texture(material.texture_diffuse0, texCoord).rgb;
    diffuseSample = texture(material.texture_diffuse0, texCoord).rgb;
    specularSample = texture(material.texture_specular0, texCoord).rgb;
